...
class Ui_Students_health_records_registration_ui(object):
    def setupUi(self, Students_health_records_registration_ui):
        ...
        self.First_name_error.setGeometry(QtCore.QRect(121, 35, 211, 16))
        ...
        self.Last_name_error.setGeometry(QtCore.QRect(121, 80, 211, 16))
        ...
        self.User_name_error.setGeometry(QtCore.QRect(121, 125, 211, 16))
        ...
        self.Password_error.setGeometry(QtCore.QRect(121, 170, 211, 16))
        ...
        self.Emai_error.setGeometry(QtCore.QRect(121, 215, 211, 16))
