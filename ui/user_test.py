...
class Ui_Student_health_records(object):
    ...
    def retranslateUi(self, Student_health_records):
        ...
        Student_health_records.setWindowTitle(_translate("Student_health_records", "Students_health_records"))
        ...
        self.pushButton.setText(_translate("Student_health_records", "PushButton"))
