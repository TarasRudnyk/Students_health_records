...
class Ui_addUserWindow(object):
    def setupUi(self, addUserWindow):
        ...
        self.full_name_error.setGeometry(QtCore.QRect(131, 91, 210, 13))
        ...
        self.group_error.setGeometry(QtCore.QRect(131, 135, 210, 13))
    ...
    def retranslateUi(self, addUserWindow):
        ...
        self.group_lineEdit.setPlaceholderText(_translate("addUserWindow", "last name"))
